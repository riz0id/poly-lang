...
-- | @since 0.1.0.0
instance HasSpan (Err s) where
  span' = lens (inputSpan . errInput) (\s t -> s & span' .~ t)
  {-# INLINE span' #-}
...
emitPlainErr msg = Err (Input mempty mempty mempty) (Just msg) mempty
